@extends('master')
@section('title', 'Perhitungan Metode Fuzzy Tsukamoto')
@section('css')
 ...
 <div class="col-lg-12 layout-spacing">
    <div class="statbox widget box box-shadow">
    	<div class="widget-content widget-content-area br-6">
	        <form action="/fuzzy/batch" method="POST" enctype="multipart/form-data" class="row">
	            @csrf
        ...
        <div class="widget-content widget-content-area">
            <div id="pills">
                @php $def = [] @endphp
                <h3>Himpunan Input</h3>
                <section>@include('fuzzy.input')</section>
                <h3>Himpunan Output</h3>
                <section>@include('fuzzy.output')</section>
                <h3>Fuzzifikasi</h3>
                <section>@include('fuzzy.fuzzification')</section>
                <h3>Basis Aturan</h3>
                <section>@include('fuzzy.rule_base')</section>
                <h3>Defuzzifikasi</h3>
                @if($rcount > 0)
                <section>@include('fuzzy.defuzzification')</section>
                @else
                <section><i>Output basis aturan belum diisi</i></section>
                @endif
                <h3>Hasil Keputusan</h3>
                @if($rcount > 0)
                <section>@include('fuzzy.result')</section>
                @else
                <section><i>Output basis aturan belum diisi</i></section>
                @endif
            </div>
