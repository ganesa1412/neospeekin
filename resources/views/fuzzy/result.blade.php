...
<p class="mt-2">
	...
	3 Kandidat dengan nilai tertinggi akan dibandingkan dengan hasil pada metode SMARTER
</p>

<div class="text-right">
	<form method="post" action="/fuzzy/pdf" id="form" class="text-right" target="_blank">
	@csrf
