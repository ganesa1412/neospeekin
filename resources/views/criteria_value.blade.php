@extends('master')
@section('title', 'Kelola Data Himpunan Fuzzy')
@section('content')
    	...
    	<div class="text-right">
    		<div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <a href="/criteria_value/create/{{$criteria_id}}" class="btn btn-primary">
            ...
            <table id="zero-config" class="table table-hover table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                    	<td>{{$no++}}.</td>
                        <td>{{$list->value}}</td>
                        <td>{{$list->domain_min}}</td>
                        <td>{{$list->domain_max}}</td>
                        <td>
							  <a href="/criteria_value/{{$list->id}}" class="btn btn-warning btn-sm">
							  ...
							  <form action="{{route('criteria_value.destroy', $list->id)}}" method="post">
							  	@csrf
